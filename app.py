...
FIRST_PURCHASE_ITEM = {
    "name":   "보름달 블렌드",  # A열 품목명 ([첫 구매 찬스] 제거)
    "weight": "250g",               # B열 중량
    "option": "갈지않음",           # C열 옵션
}
# ────────────────────────────────────────────────────────────────────────
...
# ── 품목명 접두사 치환 목록 (추가/삭제 시 여기만 수정) ─────────────────────
# [플러스] → [26년 추석] 처럼 접두사를 다른 값으로 치환하여 기존 상품과 합산
PREFIX_REPLACE = [
    ("[플러스] 드립백 & 머그 세트",              "[26년 추석] 드립백 & 머그 세트"),
    ("[플러스] 간편커피 & 머그 세트",            "[26년 추석] 간편커피 & 머그 세트"),
    ("[플러스] 엑스트라 버진 올리브 오일 세트",  "[26년 추석] 엑스트라 버진 올리브 오일 세트"),
    ("[플러스] 싱글오리진 파우더 커피 세트 (30개입)", "[26년 추석] 싱글오리진 파우더 커피 세트 (30개입)"),
    ("[플러스] 보름달 블렌드 & 드리퍼 세트",    "[26년 추석] 보름달 블렌드 & 드리퍼 세트"),
    ("[플러스] 드립백  세트 (30개입)",               "[26년 추석] 드립백 세트 (30개입)"),
    # 추가 예시: ("[플러스] 새상품", "[26년 추석] 새상품"),
]
# ────────────────────────────────────────────────────────────────────────
...
def clean_item_name(name):
    # PREFIX_REPLACE 먼저 적용 (REMOVE_STRINGS가 [플러스]를 제거하기 전에)
    for orig, repl in PREFIX_REPLACE:
        if orig in name:
